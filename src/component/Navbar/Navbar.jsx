  ...
  return (
    ...
    >
      <div className="w-full h-full flex flex-row items-center justify-between m-auto px-4 md:px-10">
        ...
        <div className="md:hidden">
          {isMobileMenuOpen ? (
            ...
            >
              <X
                size={24}
                className="transform transition-transform duration-300 rotate-90 hover:rotate-180"
              />
            </button>
          ) : (
            <button
        ...
        {/* Desktop Menu */}
        <div
          className="hidden md:flex items-center text-2xl"
          style={{ marginRight: "1rem", gap: "3rem" }}
        >
        ...
        >
          <div className="flex flex-col items-center py-4 space-y-4">
            <NavLink href="/about" mobile={true} onClick={handleMobileNavClick}>
              About
            </NavLink>
            <NavLink
              href="/contact"
