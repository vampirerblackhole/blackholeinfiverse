...
const LoadingAnimation = ({
        ...
        const animate = () => {
            ...
            if (phase === 'approach') {
                ...
                meteor.trail.forEach((pos, i) => {
                    ...
                    ctx.arc(pos.x, pos.y, pos.size * (1 - i / meteor.trail.length), 0, Math.PI * 2);
                    ctx.fill();
                });
    ...
    return (
        <div className="relative min-h-screen overflow-hidden" style={{zIndex:50}}>
            <canvas
                ref={canvasRef}
...
<div style={{
    ...
    <h1 className='font-bold  text-transparent bg-clip-text bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300 hover:to-purple-400 transition-all duration-500 hover:text-glow transform  loop-h1'>
        <span> BE A </span> PART <b><i>OF</i></b> THE <span>UNAWARE</span>  <b><i>FUTURE! </i></b>
    </h1>
